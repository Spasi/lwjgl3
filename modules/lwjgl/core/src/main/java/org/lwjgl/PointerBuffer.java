...
public class PointerBuffer extends CustomBuffer<PointerBuffer> implements Comparable<PointerBuffer> {
     ...
     */
    public PointerBuffer get(int index, long[] dst) {
     ...
     */
    public PointerBuffer get(int index, long[] dst, int offset, int length) {
     ...
     */
    public PointerBuffer put(int index, long[] src) {
     ...
     * @throws IndexOutOfBoundsException If the preconditions on the {@code index}, {@code offset}, and {@code length} parameters do not hold
     */
    public PointerBuffer put(int index, long[] src, int offset, int length) {
        checkFromIndexSize(index, length, limit());
        if (BITS64) {
